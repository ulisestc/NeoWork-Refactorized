...
$(document).ready(function() {
  ...
  const $empresaInfo = $('#empresa-info'); // <div id="empresa-info" data-id-empresa="..." data-id-candidato="...">
  ...
  $('#ratingForm').on('submit', function(e) {
    ...
    // Construir payload
    const payload = {
      id_puesto:                $('input[name="id_puesto"]').val(),
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        if (res.success) {
          ...
          window.location.href = `/NeoWork_Refactorized/Views/job_details.php?` +
                                 `id_puesto=${payload.id_puesto}&id_empresa=${payload.id_empresa}`;
        } else {
